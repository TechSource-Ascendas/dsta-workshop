-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\hdl_coder_led_blinking\FFT_Comparison\MathWorks\hdlsrc\fft8\SDFCommutator1.vhd
...
ARCHITECTURE rtl OF SDFCommutator1 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL xf_im_signed                     : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL dinXTwdlf_re_signed              : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL dinXTwdlf_im_signed              : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL btf1_re_signed                   : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL btf1_im_signed                   : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL btf2_re_signed                   : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL btf2_im_signed                   : signed(16 DOWNTO 0);  -- sfix17
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL SDFCummutator_out_im_next        : signed(16 DOWNTO 0);  -- sfix17
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(16 DOWNTO 0);  -- sfix17
  ...
  SIGNAL wrData_re_tmp                    : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL wrData_im                        : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL wrAddr_tmp                       : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL xData_re                         : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL xData_im                         : signed(16 DOWNTO 0);  -- sfix17
  ...
  SIGNAL dout0_re                         : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL dout0_im                         : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL xX_re_signed                     : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL xX_im                            : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL xX_im_signed                     : signed(16 DOWNTO 0);  -- sfix17
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_1_1_re_tmp                  : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL dout_1_1_im_tmp                  : signed(16 DOWNTO 0);  -- sfix17

BEGIN
  u_dataXMEM_re_0_1 : SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_1 : SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 17
                 )
    PORT MAP( clk => clk,
