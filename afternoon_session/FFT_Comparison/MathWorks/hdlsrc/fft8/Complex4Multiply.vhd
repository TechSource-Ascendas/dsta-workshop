-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\hdl_coder_led_blinking\FFT_Comparison\MathWorks\hdlsrc\fft8\Complex4Multiply.vhd
...
-- Source Path: fft8/fft8_dut/FFT/RADIX22FFT_SDF1_3/Complex4Multiply
-- Hierarchy Level: 3
-- Model version: 1.11
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF Complex4Multiply IS
  ...
  -- Signals
  SIGNAL din_re_signed                    : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL din_re_reg                       : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL din_im_signed                    : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL din_im_reg                       : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL twdl_3_re_signed                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_re_reg                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_3_im_signed                 : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL prod1_re                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En14
  SIGNAL prod1_im                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En14
  SIGNAL prod2_re                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En14
  SIGNAL prod2_im                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En14
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL Complex4Add_sub_cast             : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL Complex4Add_sub_cast_1           : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL Complex4Add_add_cast             : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL Complex4Add_add_cast_1           : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL mulResFP_re                      : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL mulResFP_im                      : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL dinXTwdl_3_vld_1                 : std_logic;
  SIGNAL dinXTwdl_re_tmp                  : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL dinXTwdl_im_tmp                  : signed(18 DOWNTO 0);  -- sfix19
...
BEGIN
  ...
  twdl_3_re_signed <= signed(twdl_3_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        twdl_re_reg <= twdl_3_re_signed;
      END IF;
    END IF;
  END PROCESS intdelay_2_process;


  twdl_3_im_signed <= signed(twdl_3_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        dinXTwdl_3_vld_1 <= Complex4Add_prod_vld_reg1;
