...
HD_PWD='C:/demo/hdl_coder_led_blinking/MathWorks/hdl_prj/vivado_prj_new/vivado_prj_new.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flash_led_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flash_led_top.tcl
