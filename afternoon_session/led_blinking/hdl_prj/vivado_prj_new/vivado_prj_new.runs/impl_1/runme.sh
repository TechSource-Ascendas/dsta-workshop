...
HD_PWD='C:/demo/hdl_coder_led_blinking/MathWorks/hdl_prj/vivado_prj_new/vivado_prj_new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flash_led_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flash_led_top.tcl -notrace
