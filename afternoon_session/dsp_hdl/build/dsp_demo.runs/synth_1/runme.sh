...
HD_PWD='C:/demo/hdl_coder_led_blinking/dsp_hdl/build/dsp_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_filter_dut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp_filter_dut.tcl
