...
HD_PWD='C:/demo/hdl_coder_led_blinking/dsp_hdl/build/dsp_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_filter_dut.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dsp_filter_dut.tcl -notrace
